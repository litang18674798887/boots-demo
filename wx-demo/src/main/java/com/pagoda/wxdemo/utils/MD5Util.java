package com.pagoda.wxdemo.utils;
...
public class MD5Util {
    ...
    public static String MD5Encode(String origin,String a) {
        String resultString = null;
        try {
            resultString = new String(origin);
            MessageDigest md = MessageDigest.getInstance("MD5");
            resultString = byteArrayToHexString(md.digest(resultString.getBytes(a)));
        } catch (Exception ex) {
        }
        return resultString;
    }
...
//        boolean b = MD5Util.isValidate("123", "21232f297a57a5a743894a0e4a801fc3");
        String aaaaa = MD5Encode("aaaaa", "UTF-8");
